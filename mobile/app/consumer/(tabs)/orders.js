...
export default function Orders() {
    ...
    // Simulated fetch
    const fetchOrders = useCallback(async ({ page = 1, pageSize = 8 } = {}) => {
    ...
    const filtered = orders.filter((o) => {
        ...
        return o.number.toLowerCase().includes(q) || o.items.some((it) => it.title.toLowerCase().includes(q));
    });
                ...
                <View style={styles.modalBackdrop}>
                    <View style={styles.modalCard}>
                        ...
                        <View style={styles.modalFooter}>
                            <TouchableOpacity style={styles.primaryBtn} onPress={closeOrder}>
